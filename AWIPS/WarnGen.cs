...
namespace AWIPS
{
    public partial class WarnGen : Form
    {
        ...
        private async Task fetchVtecInformation2(string vtecThing)
        {
            Globals.nextVtec = "0000";
            string url = $"http://{Globals.serverip}/getvtecnumber/{Globals.username}/{Globals.password}/{Globals.officeId}.{vtecThing}";
            try
            {
                HttpResponseMessage response = await client.GetAsync(url);
                response.EnsureSuccessStatusCode();
        ...
        private async void fetchSevereWeatherStatementProduct(int uuid)
        {
            ...
            try
            {
                ...
                using (JsonDocument doc = JsonDocument.Parse(jsonString))
                {
                        ...
                        statusElement.GetString() == "success")
                    {
                        ...
                        if (root.TryGetProperty("endtime", out JsonElement statusElement5))
                        {
                            ...
                            if ((Globals.warningSelected == 5 || Globals.warningSelected == 7 || Globals.warningSelected == 9 || Globals.warningSelected == 11 || Globals.warningSelected == 26 || Globals.warningSelected == 27) && dataList[uuid + 2] == "EXT")
                            {
                ...
                {
                    if (Globals.svsWarningType == "SV.W" || Globals.svsWarningType == "TO.W")
                    {
                        lbSelections.Items.Clear();
                        foreach (var item in Globals.warngenCancellationMenu)
                        {
                            if (item is string textItem)
                            {
                                lbSelections.Items.Add(textItem);
                    ...
                    else
                    {
                        ...
                        if (Globals.warningSelected == 26 || Globals.warningSelected == 27)
                        {
                            await fetchVtecInformation2("TO.A");
                            await fetchVtecInformation2("SV.A");
                        }
                        else
                        {
        ...
        {
            if (Globals.warningSelected == 2 || Globals.warningSelected == 5 || Globals.warningSelected == 7 || Globals.warningSelected == 9 || Globals.warningSelected == 11 || Globals.warningSelected == 26 || Globals.warningSelected == 27)
            {
        ...
        private void ddOther_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (rdoOther.Checked)
            {
                ...
                else if (Globals.warningSelected == 26)
                {
                    cbUpdateList.Enabled = true;
                    lbSelections.Items.Clear();
                    foreach (var item in Globals.warngenWatchCountyFollowupSelections)
                    {
                        if (item is string textItem)
                        {
                            lbSelections.Items.Add(textItem);
                    ...
                    fetchSevereWeatherStatementFollowups("wwrelay");
                }
                else if (Globals.warningSelected == 27)
                {
                    cbUpdateList.Enabled = true;
                    lbSelections.Items.Clear();
                    foreach (var item in Globals.warngenWatchCountyFollowupSelections2)
                    {
                        if (item is string textItem)
                        {
                            lbSelections.Items.Add(textItem);
                    ...
                    fetchSevereWeatherStatementFollowups("wcn");
                }
                else
                {
                    cbUpdateList.Enabled = false;
        ...
        private void rdoSpecialWx_CheckedChanged(object sender, EventArgs e)
        {
            ...
            lbSelections.Items.Clear();
            if (Globals.officeId == "FFC")
            {
                foreach (var item in Globals.warngenSpecialWeatherStatementSelectionsFFC)
                {
                    if (item is string textItem)
                    {
                        lbSelections.Items.Add(textItem);
        ...
        {
            if (rdoSevereWx.Checked || Globals.warningSelected == 5 || Globals.warningSelected == 7 || Globals.warningSelected == 9 || Globals.warningSelected == 11 || Globals.warningSelected == 26 || Globals.warningSelected == 27)
            {
        ...
        private void cbUpdateList_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (cbUpdateList.SelectedIndex == 1)
            {
                ...
                if (Globals.warningSelected == 26)
                {
                    fetchSevereWeatherStatementFollowups("wwrelay");
                }
                if (Globals.warningSelected == 27)
                {
                    fetchSevereWeatherStatementFollowups("wcn");
                }
                lbSelections.Items.Clear();
